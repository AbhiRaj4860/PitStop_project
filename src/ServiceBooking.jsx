...
function ServiceBooking() {
  ...
  const handleSubmit = (e) => {
   ...
   setBookingData((prev) => [
  ...(prev || []),   // keep previous bookings
  {
    ...form,
    mainService,
    serviceName: form.selectedService,
    status: "In Queue",   // ✅ initial status
  },
]);
    ...
    <div style={styles.wrapper}>
      <div style={styles.card}>
        <h2 style={styles.heading}>
          Book Your Slot for{mainService ? `: ${mainService}` : ": Service"}
        </h2>
        <form onSubmit={handleSubmit} style={{ width: "100%" }}>
          ...
          {/* Date - restrict to today or future */}
          {/* prevents past dates */}
          <input
            type="date"
            name="date"
